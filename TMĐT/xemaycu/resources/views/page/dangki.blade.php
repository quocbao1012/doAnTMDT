		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-8 p-b-30">
					...
					<form action="{{route('signin')}}" method="post" enctype="multipart/form-data" class ="formdangky">
						...
						@if(isset($_REQUEST['makichhoat']))
						<label>Mã kích hoạt:</label>
						<div class="pos-relative bo12 of-hidden size25">							
							<input type="text" name="makichhoat" id="makichhoat" value="{{$_REQUEST['makichhoat']}}" class="s-text7 size16 p-l-23 p-r-50">
						</div>
						@else
						<label>Mã kích hoạt:</label>
						<div class="pos-relative bo12 of-hidden size25">							
							<input type="text" name="makichhoat" id="makichhoat" class="s-text7 size16 p-l-23 p-r-50">
						</div>
						@endif
						...
						<label></label>
						<form action="{{route('sendmail')}}" method="post" class ="formsendmail" onsubmit="return ktmail()">
							<input type="hidden" name="_token" value="{{ csrf_token() }}">
						
						<script type="text/javascript">
							function mail()
							{		
								document.getElementById("hoten2").value = document.getElementById("hoten").value;
								document.getElementById("sdt2").value = document.getElementById("sdt").value;
								document.getElementById("cmnd2").value = document.getElementById("cmnd").value;
								document.getElementById("email2").value = document.getElementById("email").value;
								document.getElementById("diachi2").value = document.getElementById("diachi").value;
								document.getElementById("password2").value = document.getElementById("password").value;
								document.getElementById("repassword2").value = document.getElementById("repassword").value;	
								document.getElementById("loaitv2").value = document.getElementById("loaitv").value;								
								document.getElementById("makichhoat2").value = document.getElementById("makichhoat").value;						
							}	
							...
							function ktmail()
							{
    							...
    							{ 
             						alert('Hãy nhập địa chỉ Email hợp lệ để nhận mã xác nhận!!!.\nExample@gmail.com');
						...
						<input type="hidden" name="hoten2" id="hoten2">
						<input type="hidden" name="sdt2" id="sdt2">
						<input type="hidden" name="cmnd2" id="cmnd2">			   
						<input type="hidden" name="email2" id="email2">
						<input type="hidden" name="diachi2" id="diachi2">
						
						<input type="hidden" name="password2" id="password2">
						<input type="hidden" name="repassword2" id="repassword2">
						<input type="hidden" name="loaitv2" id="loaitv2">
						<input type="hidden" name="makichhoat2" id="makichhoat2">

							<button onclick="mail();" class="flex-c-m size25 bg4 bo-rad-23 hov1 m-text3 trans-0-4" style="width: 60%;height: 40px;">
