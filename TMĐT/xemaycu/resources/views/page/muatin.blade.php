									...
									<div class="block2-overlay trans-0-4">
										...
										<div class="block2-btn-addcart w-size1 trans-0-4">
											...
											<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" target="_top">
												...
												<input type="hidden" name="item_number" value="{{$goi->MAGOITIN}}">
												<input type="hidden" name="amount" value="{{$goi->GIA}}">
												...
												<input type="hidden" name="currency_code" value="USD">
												<input type="hidden" name="return" value="http://localhost/xemaycu-c2c/public/buynew2?matv={{Auth::user()->id}}&tongtien={{$goi->GIA}}&sotin={{$goi->SOTIN}}">
												<input type="hidden" name="cancel_return" value="http://localhost/xemaycu-c2c/public/buynew">

												<input type="hidden" name="bn" value="PP-BuyNowBF:btn_buynowCC_LG.gif:NonHostedGuest">
												<input type="image" src="https://www.paypalobjects.com/webstatic/en_AU/i/buttons/btn_paywith_primary_m.png" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
