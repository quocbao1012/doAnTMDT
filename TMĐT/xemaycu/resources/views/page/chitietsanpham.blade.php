			...
			<div class="w-size14 p-t-30 respon5">
				...
				<div class="p-t-33 p-b-60">								
					<!-- Button -->
						...
						@elseif(Auth::check() && Auth::user()->loaitv =="W")
						<a href="index">
						<button class="flex-c-m sizefull bg9 bo-rad-23 hov1 s-text1 trans-0-4" style="height: 40px">					
									<i class="fa fa-phone m-r-20" aria-hidden="true"></i> Admin không được đặt hàng !!!
						</button>
						</a>
						@elseif(Auth::check() && $pro->kiemduyet == 1 && Auth::user()->loaitv !="W")
